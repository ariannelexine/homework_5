 ...
 */
	Head h("HEADFDSF", 123, "idk", 4.5, 100, "fsaf");
...
void CreateRobotParts::createTorso(){
   ...
   */
	Torso t("TOST", 4233243, "idk", 333, 200, "sdfas",3);
...
void CreateRobotParts::createArm(){
   ...
   */
	Arm a("ARMSSSZZZ", 423, "t", 777.6, 300, "thh", 444);
	allArms.push_back(a);
}
 ...
 */
	Locomotor l("LOCOO", 234, "i", 3, 150, "poi", 123, 321);
 ...
 */
	Battery b("BATTTSHIT", 000, "o", 4.4, 90, "fsaf", 234);
